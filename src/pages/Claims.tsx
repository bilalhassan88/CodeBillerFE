              ...
              <tbody>
                {items.map((c) => (
                  <tr key={c.id} className="border-b border-slate-100 hover:bg-slate-50/50">
                    ...
                    <td className="py-3 text-slate-600">{c.submittedAt ? new Date(c.submittedAt).toLocaleDateString() : '—'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            <div className="flex items-center justify-between border-b border-slate-200 pb-4">
              <h2 className="text-lg font-semibold text-slate-900">New claim</h2>
            ...
            <form onSubmit={handleAdd} className="mt-4 space-y-3">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700">Insurance *</label>
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700">Total billed ($) *</label>
